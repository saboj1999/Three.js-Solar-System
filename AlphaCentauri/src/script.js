 ...
 * Parameters
 */
const defaultScaleFactor = Math.pow(10, 11) // 10^9 is good too with use of camera views
...
const proximaCentauriCRotation = Math.PI * .6;
...
// Alpha Centauri B
const alphaCentauriB = createStarMesh(alphaCentauriBRadius, 'sun.jpg', '#f78605', .85)
scene.add(alphaCentauriB)

// Proxima Centauri
const proximaCentauri = createStarMesh(proximaCentauriRadius, 'sun.jpg', '#ff0000', .9)
scene.add(proximaCentauri)

// Proxima Centauri B
const proximaCentauriB = createBodyMesh(proximaCentauriBRadius, 'venus.jpg')
scene.add(proximaCentauriB)

// Proxima Centauri C
const proximaCentauriC = createBodyMesh(proximaCentauriCRadius, 'mercury.jpg')
 ...
 */
// const sunObject = new Star('Sun', 0, 0, 0, 0, 0, 0, sun, sunMass, sunRadius, sunRotation, sunLuminosity);
const alphaCentauriAObject = new Star('Alpha Centauri A', -10.9 * AU/2, 0, 0, 0, 0, 5000, alphaCentauriA, alphaCentauriAMass, alphaCentauriARadius, alphaCentauriARotation, alphaCentauriALuminosity, 1.25);
const alphaCentauriBObject = new Star('Alpha Centauri B', 12.8 * AU/2, 0, 0, 0, 0, -5000, alphaCentauriB, alphaCentauriBMass, alphaCentauriBRadius, alphaCentauriBRotation, alphaCentauriBLuminosity, 1.25);
const proximaCentauriObject = new Star('Proxima Centauri', 2500 * AU, 0, 0, 0, 0, -22000, proximaCentauri, proximaCentauriMass, proximaCentauriRadius, proximaCentauriRotation, proximaCentauriLuminosity, .8);
const proximaCentauriBObject = new Planet('Proxima Centauri B', 2500 * AU + .5 * AU, 0, 0, 0, 0, -22000 - 12500, proximaCentauriB, proximaCentauriBMass, proximaCentauriBRadius, proximaCentauriBRotation, proximaCentauriBAlbedo, proximaCentauriBEmissivity);
const proximaCentauriCOCject = new Planet('Proxima Centauri C', 2500 * AU + 1.49 * AU, 0, 0, 0, 0, -22000 - 7500, proximaCentauriC, proximaCentauriCMass, proximaCentauriCRadius, proximaCentauriCRotation, proximaCentauriCAlbedo, proximaCentauriCEmissivity);
