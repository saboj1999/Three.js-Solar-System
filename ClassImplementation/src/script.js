...
const venusRadius = .50 * radiusMod
const earthRadius = .50 * radiusMod
const moonRadius = .20 * radiusMod
const marsRadius = .35 * radiusMod
...
const mercuryObject = new Planet('Mercury', .4 * AU, 0, 0, 0, 0, -47000, mercury, mercuryMass, mercuryRadius, mercuryRotation, mercuryAlbedo, mercuryEmissivity);
const venusObject = new Planet('Venus', .7 * AU, 0, 0, 0, 0, -35020, venus, venusMass, venusRadius, venusRotation, venusAlbedo, venusEmissivity);
...
const marsObject = new Planet('Mars', 1.5 * AU, 0, 0, 0, 0, -24077, mars, marsMass, marsRadius, marsRotation, marsAlbedo, marsEmissivity)
...
let venusTempText = document.getElementById("venusTemp")
let earthTempText = document.getElementById("earthTemp")
let marsTempText = document.getElementById("marsTemp")
...
const tick = () =>
{
    ...
    let venusTemp = calculateTemperature(venusObject, sunObject);
    let earthTemp = calculateTemperature(earthObject, sunObject);
    let marsTemp = calculateTemperature(marsObject, sunObject);
    

    mercuryTempText.innerText = "Mercury: "+ parseFloat(mercuryTemp).toFixed(2) +'\n'
    venusTempText.innerText = "Venus: "+ parseFloat(venusTemp).toFixed(2) + '\n'
    earthTempText.innerText = "Earth: "+ parseFloat(earthTemp).toFixed(2) + '\n'
    marsTempText.innerText = "Mars: "+ parseFloat(marsTemp).toFixed(2)
